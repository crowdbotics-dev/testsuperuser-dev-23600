...
## Project Structure
    ...
    ├── testsuperuser_dev_23600  # Django project configurations
...
1. Clone this repo and `cd testsuperuser_dev_23600`
...
2. Clone this repo and `cd testsuperuser_dev_23600`
